...
from app.routes.sensor_routes import sensors_bp
from app.routes.atuador_routes import atuadores_bp
from app.routes.user_routes import user_bp
from app.routes.mqtt_routes import mqtt_routes_bp
from app.mqtt.cliente import init_mqtt
